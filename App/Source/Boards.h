...
#elif defined(CONFIG_TT_BOARD_CYD_2432S022C)  // Added condition for CYD-2432S022C
#include "CYD2432S022C.h"
#define TT_BOARD_HARDWARE &cyd_2432S022C_config  // Ensure the correct config is defined
